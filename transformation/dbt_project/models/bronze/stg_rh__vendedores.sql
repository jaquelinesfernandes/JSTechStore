...
{% if _n == 0 %}
  ...
  {% else %}
SELECT NULL::INTEGER AS id_vendedor, NULL::INTEGER AS id_loja,
       NULL::VARCHAR AS nome, NULL::VARCHAR AS cpf, NULL::VARCHAR AS email,
       NULL::VARCHAR AS cargo, NULL::DATE AS data_admissao, NULL::BOOLEAN AS ativo,
